...
## 從哪開始??
1. 請到 [Release 區](/../../releases) 下載 : 包括 Demo App 的 source code (壓縮檔) 與 SDK library (.a)
...
|:-----------|:-------------|:-----------|:-----------|:-----------|:-----------|
| 訊息通知 (ANCS) | <ul><li>- [x] </li></ul> | <ul><li>- [x] </li></ul> | <ul><li>- [x] </li></ul> | <ul><li>- [x] </li></ul> | <ul><li>- [x] </li></ul> |
